...
Veja mais detalhes na seção [Autenticação](/autenticacao).
...
Veja mais detalhes na [Referencia da API](/api-reference).
...
→ Veja exemplos e parâmetros na [Referencia da API](/api-reference).
...
→ Consulte a [Referencia da API](/api-reference).
...
Caso não tenha experiência com GraphQL, recomendamos explorar a seção [Conceitos de GraphQL](/por-onde-comecar/conceitos-de-graphql) para entender a estrutura das consultas e mutations antes de avançar para chamadas mais complexas.
...
- [Conceitos de GraphQL](/por-onde-comecar/conceitos-de-graphql)
